...
| M5 Quality & cleanup | 🔄 M5a DONE; M5b-001/2/3 DONE; M5c-001 DONE; M5c-002 DONE (F-26); F-23b + M5c-003 pending | F-26: TTL-aware caching for passenger route-discovery data (terminals/orgs/routes/stops, 24h default) — repeat searches skip the ~30-call fan-out; stale fallback on network failure; TTL injectable for tests. Passenger suite 56/56. Remaining: F-25 localization (M5c-003), cargo/trip/routes screen tests (F-24 part 2), F-23b rename |
